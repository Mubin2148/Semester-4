import 'dart:convert';
import 'package:demo_project/AddEditPage.dart';
...
class _LaptopPageState extends State<LaptopPage> {
  ...
  Future<dynamic> laptopList() async {
    http.Response res = await http.get(
      Uri.parse('https://669f4584b132e2c136fd2c80.mockapi.io/laptops'),
  ...
  Future<dynamic> deleteById(id) async {
    http.Response res = await http.delete(
      Uri.parse('https://669f4584b132e2c136fd2c80.mockapi.io/laptops/' + id),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
    );
