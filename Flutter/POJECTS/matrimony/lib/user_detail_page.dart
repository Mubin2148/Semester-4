...
import 'package:my_flutter_app/new_user_page.dart';
                    ...
                    SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          textBox(
                              label: "Name  :  ",
                              info: widget.detailsMap.Username),
                          textBox(
                              label: "City  :  ", info: widget.detailsMap.City),
                          textBox(
                              label: "Age  :  ",
                              info: widget.detailsMap.Age.toString()),
                        ],
                      ),
                    ),
                  ],
