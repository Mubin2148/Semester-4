...
import 'package:my_flutter_app/matrimony_login_page.dart';
            ...
            Row(
              children: [
                getCustomButton(
                  ...
                  login: true,
                  navigateRoute:
                      UserLoginPage(isLogin: isLogin, userList: userList),
                ),
                getCustomButton(
                  ...
                  login: false,
                  navigateRoute:
                      UserLoginPage(isLogin: !isLogin, userList: null),
                ),
              ],
            )
          ],
      ...
      child: Container(
        ...
        child: TextButton(
          ...
          child: Text(
            btnName,
            style: TextStyle(
                color: txtColor, fontSize: 17, fontWeight: FontWeight.w700),
          ),
        ),
      ),
    );
